        ...
        <main>
            <div className="container">
                ...
                <div className="cart-note">
                    <img src={error} alt="" />
                    <span>Please, hurry! Someone has placed an order on one of the
                        items you have in the cart. We'll keep it for you for 14:17 minutes..</span>
                </div>
                <div className="row">
                    <div className="cart-lists">
                        ...
                        <div className="cart-lists__item">
                            ...
                            <div>$69.00</div>
                            <div><img src={remove} alt="" /></div>
                        </div>
                        <div className="cart-lists__gift">
                            <img src={gift} alt="" />
                            <p>Do you want a gift wrap?  <b>Only for $10.00</b></p>
                            <Link to='/'>Add</Link>
                        </div>
                        <div className="cart-lists__comment">
                            <span>Additional comments</span><br />
                            <textarea name="" id="" placeholder='Spesial instruction for seller...'>
                            </textarea>
                        </div>
                    ...
                    <div className="cart-ordersummary">
                        ...
                        <div className="cart-ordersummary__shipfrom">
                            ...
                            <div className='checkbox'>
                                <input type="checkbox" />
                                <p>i agree with the span <Link to='./'>Terms & conditons</Link></p>
                            </div>
                            <div className='btn'>
